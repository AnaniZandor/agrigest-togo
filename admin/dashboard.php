...
<header>
    <div class="header-inner">
        <h1><i class="fas fa-seedling" style="color: var(--primary);"></i> AgriGest Togo - Admin</h1>
        
        <button class="hamburger" aria-label="Menu principal" aria-expanded="false">
            <span></span>
            <span></span>
            <span></span>
        </button>
            ...
            <section class="statistics">
                ...
                <div class="dashboard-grid">
                    <div class="stat-card">
                        ...
                        <a href="agriculteurs.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>

                    <div class="stat-card">
                        <div class="label">Coopératives</div>
                        <div class="number"><?php echo $stats['cooperatives']; ?></div>
                        <a href="cooperatives.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>

                    <div class="stat-card">
                        <div class="label">Cultures</div>
                        <div class="number"><?php echo $stats['cultures']; ?></div>
                        <a href="cultures.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>

                    <div class="stat-card">
                        <div class="label">Parcelles</div>
                        <div class="number"><?php echo $stats['parcelles']; ?></div>
                        <a href="#" class="btn btn-sm btn-secondary">Voir</a>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <a href="zones.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>

                    <div class="stat-card">
                        <div class="label">Intrants</div>
                        <div class="number"><?php echo $stats['intrants']; ?></div>
                        <a href="intrants.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>

                    <div class="stat-card">
                        <div class="label">Saisons</div>
                        <div class="number"><?php echo $stats['saisons']; ?></div>
                        <a href="saisons.php" class="btn btn-sm btn-secondary">Gérer</a>
                    </div>
                </div>
            </section>
